...
```
Project:      Unity-MC
Description:  No description — update this.
Status:       planning
...
```
Language:     Detected: Node.js/TypeScript · Next.js
...
---
*Auto-generated: 2026-07-23 | Extends: ShadowWalkerNC/.github/AGENTS.md | Repo: [Unity-MC](https://github.com/ShadowWalkerNC/Unity-MC)*
